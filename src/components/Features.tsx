  ...
  const features = [
    {
      ...
      description:
        'Access questions from LeetCode, Codeforces, GeeksforGeeks, CSES, LightOJ, CodeChef, AtCoder, and many more platforms in one unified interface.',
    ...
    },
    {
      ...
      description:
        'Filter questions by difficulty, topics, companies, contest types, or your custom preferences to practice exactly what you need.',
    ...
    },
    {
      ...
      description:
        'Built-in code editor with syntax highlighting, autocomplete, and one-click download/submit functionality directly to platforms.',
    ...
    },
    {
      ...
      description:
        'Get instant help with your code, debugging assistance, algorithm explanations, and optimization suggestions from our AI chatbot.',
    ...
    },
    {
      ...
      description:
        'Take organized notes for each question, save your approaches, bookmark important problems, and create your personal study guide.',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 md:px-16">
        <div className="text-center mb-16">
          <p className="text-lg text-neutral-300 max-w-2xl mx-auto">
            Everything you need to master data structures, algorithms, and ace

    ...
    <div className="relative min-h-screen w-full flex items-center justify-center bg-black">
      ...
      <div className="w-full max-w-6xl mx-auto px-6 sm:px-10 md:px-16 pt-28 pb-20 z-10 relative">
        ...
        <div className="text-center mb-16">
          <h1 className="flex items-center justify-center gap-3 text-4xl md:text-6xl font-extrabold pb-4 mb-6 min-h-[4rem] md:min-h-[6rem]" style={{ fontFamily: "'Fira Code', monospace", background: 'linear-gradient(135deg, #7c8bd2, #5d6bb7, #3f4b9c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
            <Image src="/code.png" alt="DSA Master Logo" width={48} height={48} />
            {displayText}
            <span 

...
const ProblemsHeader = () => (
  <div className="flex flex-col mx-2 md:flex-row md:justify-between md:items-start mb-8 gap-4 md:gap-6">
    <div>
      <h1
        className="text-2xl xs:text-3xl sm:text-5xl md:text-7xl font-black mb-3 sm:mb-4"
        style={{

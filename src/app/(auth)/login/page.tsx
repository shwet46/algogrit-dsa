        ...
        <div className="relative min-h-screen w-full flex items-center justify-center p-4 overflow-y-auto">
          <div className="w-full max-w-md mx-auto py-8">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-7 text-center">
                  <p className="text-zinc-400 text-sm">
                    ...
                    <a href="/signup" className="text-white font-semibold hover:underline hover:text-zinc-200 transition-colors duration-150">
                      Sign up
                    </a>
                  </p>
                </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-zinc-600 text-xs font-medium">© 2025 AlgoGrit DSA. All rights reserved.</p>
            </div>
          </div>
        </div>
      </WavyBackground>
